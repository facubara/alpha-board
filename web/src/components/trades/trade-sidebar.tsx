...
export function TradeSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar panel */}
      <aside
        className={`fixed bottom-0 right-0 top-14 z-40 w-full border-l border-[var(--border-default)] bg-[var(--bg-base)] transition-transform duration-200 ease-in-out sm:w-80 ${
