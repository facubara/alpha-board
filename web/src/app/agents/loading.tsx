    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-2">
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="h-8 w-16 rounded-md bg-[var(--bg-muted)] skeleton" />
        ))}
      </div>
      ...
      <div className="overflow-hidden rounded-lg border border-[var(--border-default)]">
        <div className="flex h-10 items-center gap-6 bg-[var(--bg-surface)] px-4">
          <div className="h-3 w-32 rounded bg-[var(--bg-muted)] skeleton" />
        ...
        {Array.from({ length: 10 }).map((_, i) => (
          ...
          >
            <div className="h-4 w-36 rounded bg-[var(--bg-muted)] skeleton" />
            <div className="h-3 w-10 rounded bg-[var(--bg-muted)] skeleton" />
            <div className="h-3 w-16 rounded bg-[var(--bg-muted)] skeleton" />
            <div className="h-3 w-12 rounded bg-[var(--bg-muted)] skeleton" />
          </div>
